<?php
    ...
    */
	...
	#Revised enum string with new custom statuses
    	$g_status_enum_string =  '10:open,15:unassigned,20:feedback,23:needs jf decission,25:postponed,35:funding needed,50:assigned,60:fixing acc to prio,80:resolved,90:closed';


    	# Status color additions
        $g_status_colors['open'] 		    = '#fcbdbd'; # red    (scarlet red #ef2929)
    	$g_status_colors['unassigned']              = '#D2B48C'; // brown (tan  #D2B48C)
    	$g_status_colors['needs jf decission']	    = '#f0fff0'; // HoneyDew 
